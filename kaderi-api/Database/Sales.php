...
FROM users, sales, products, stores WHERE (users.store_id=:store_id AND sales.user_id = users.id AND sales.product_id = products.id AND
 stores.id=:store_id) ORDER BY sale_date DESC ");
